	    ...
	    <section class="body-inicio">
	        ...
	        <div class="container-fluid">
	            ...
	            <div class="row">
					...
					<c:if test="${user.userType.id == 2 || user.userType.id == 3 }">
						<div class=" btn-inicio col-2">
	                    <!--BOTONES ENLAZAR-->
		                    <a href="#" category="Todo" class="w-100 btn btn-lg btn-primary" role="button">TODO</a>
		                    <a href="#" category="REVISION" class="w-100 btn btn-lg btn-warning" role="button">REVISION</a>
		                    <a href="#" category="APROBADO" class="w-100 btn btn-lg btn-success" role="button">APROBADO</a>
		                    <a href="#" category="RECHAZADO" class="w-100 btn btn-lg btn-danger" role="button">RECHAZADO</a>	                   
	                	</div>
	                ...
	                <div class="accesos col-10">
						...
						<c:forEach items="${lugares}" var="lugar">
							<div class="acceso" category="${lugar.getLugarEstado().getNombre()}">
		                        <!--acceso 1-->
		                        ...
		                        <h1  class="btn-ver btn-lg btn-dark"  
		                            ><c:out value="${lugar.getLugarEstado().getNombre()}"/></h1>
	                ...
	                <!--primary secondary success danger warning info light dark-->
					<div class=" btn-inicio col-2"></div>
	                <div class="accesos col-8">
						...
						<c:forEach items="${lugares}" var="lugar">
							<div class="acceso" category="${lugar.getLugarEstado().getNombre()}">
		                        ...
		                        <a href="/aprobar/${lugar.getId()}" category="aprobado" class="w-100 btn btn-lg btn-success" role="button">APROBAR</a>
		                        <br></br>
		                        
		                        <br></br>
		                    	<a href="/rechazar/${lugar.getId()}" category="rechazado" class="w-100 btn btn-lg btn-danger" role="button">RECHAZAR</a>	
