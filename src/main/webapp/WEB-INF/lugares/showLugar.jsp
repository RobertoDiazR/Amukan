        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="accesos col-10">
                    ...
                    <h6><c:out value="${comuna.getProvincia().getRegion().getNombre()}"/>  >  <c:out  value="${comuna.getProvincia().getNombre() }"/> >  <c:out value="${comuna.getNombre()}"/></h6><!--TITULOS-->
