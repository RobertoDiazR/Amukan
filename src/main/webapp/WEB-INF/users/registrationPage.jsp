...
<head>
    ...
    <title>AMUKAN/inicio-sesión</title>
</head>
<body>
     <header>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="accesos-registro">
                <div class="acceso-registro">
                    <!--acceso 1-->
                    <h1>Cuenta de turista </h1><br>
                    <img src="/img/turista.jpg" alt="imagen" />
                    <!--imagen acceso directo 1-->
                    
                    <br><br>
                    <p>Al registrarte como turista formaras parte de amukan y tendrás acceso a los diferentes datos 
                    de hospedaje, gastronomía, turismo, comercio local y servicios básicos de las regiones dentro de
                     Chile. También tendrás la posibilidad de  comentar y evaluar los diferentes negocios que conozcas
                      .</p>
                   
                    <a href="/registration/turista" class="btn-ver btn-lg btn-dark" role="button">Registrarme como turista</a>
                </div>
                <!--fin acceso directo -->
                ...
                <div class="acceso-registro">
                    <!--acceso 1-->
                    <h1>Cuenta de empresa </h1><br>
                    <img src="/img/empresa.jpg" alt="imagen" />
                    <!--imagen acceso directo 1-->
                    
                    <br><br>
                    <p>Al registrarte como empresa, tu negocio formará parte de amukan, y la información que registres podrá ser vista por todos los viajeros y turistas que visiten nuestra pagina.

						Una vez registrado las personas podrán visualizar, contactar , calificar y comentar  tu empresa. 

						
</p>
                   
                    <a href="/registration/empresa" class="btn-ver btn-lg btn-dark" role="button">Registrarme como empresa</a>
