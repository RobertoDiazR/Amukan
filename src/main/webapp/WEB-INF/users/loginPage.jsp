        ...
        <div class="container-fluid">
	        <main class="form-signin">
	            <form method="post" action="/login">
	                ...
	                <!--CONTRASEÑA-->
	                <input type="submit" id="submit" value="Ingresar" class="w-100 btn btn-lg btn-dark" role="button"/>
	            </form>
                ...
                <a class="link-checkin" href="/registration">¿No tienes una cuenta? registrate aquí</a>
